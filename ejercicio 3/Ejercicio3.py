...
def mostrarPosThor(numero):
    if numero is not None:
        numero = numero -1
        print('Thor se encuentra en la posicion: ', numero)
    else:
        print('Thor no esta en esta lista')
...
def agregarPersonajesOtraLista(objListaRecibe, objListaDa):
    conjunto = []
...
def mostrarPersonajeDeLaPosicionPedida(objLista):
...
def ejercicio3():
    ...
    agregarPersonajesOtraLista(objLista, objLista2)
